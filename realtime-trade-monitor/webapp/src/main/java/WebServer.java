...
public class WebServer {
    ...
    private final static Map<String, WsContext> sessions = new ConcurrentHashMap<>();
    private final static Map<String, List<WsContext>> symbolsToBeUpdated = new ConcurrentHashMap<>();
    private final static JetInstance jet = Jet.newJetClient();


    public static void main(String[] args) {
        IMap<String, Tuple3<Long, Long, Integer>> results = jet.getMap("query1_Results");
